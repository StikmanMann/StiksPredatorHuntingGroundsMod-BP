...
var _a, _AwaitFunctions_awaitPlayer;
...
class AwaitFunctions {
    ...
    static async waitForPlayer(playerName, attempts, log) {
        await __classPrivateFieldGet(this, _a, "m", _AwaitFunctions_awaitPlayer).call(this, playerName, attempts, log);
...
_a = AwaitFunctions, _AwaitFunctions_awaitPlayer = function _AwaitFunctions_awaitPlayer(playerName, attempts, log) {
    return new Promise((resolve) => {
        let player;
        let attempt = 0;
