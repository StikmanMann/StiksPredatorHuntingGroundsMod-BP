...
import { midGame, preLobby, predators, setMidGame, setPreLobby, survivors } from "./privateGameVars";
...
world.afterEvents.playerSpawn.subscribe(async (eventData) => {
    ...
    if(spawnLocations.length == 0){world.sendMessage("no spawnpoints found bozo"); return}
